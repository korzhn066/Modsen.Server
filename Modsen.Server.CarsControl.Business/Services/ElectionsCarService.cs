...
{
    internal class ElectionsCarService(IMongoRepositoryFactory<BsonDocument> mongoRepositoryFactory)
        : CarServiceBase(mongoRepositoryFactory.Create(nameof(CarType.Elections))), IElectionsCarService
    {
    }
}
