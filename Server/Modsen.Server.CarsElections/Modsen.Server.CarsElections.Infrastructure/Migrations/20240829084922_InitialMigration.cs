...
namespace Modsen.Server.CarsElections.Infrastructure.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "Id", "CarId", "DateTime", "DislikeCount", "LikeCount", "Message", "Type" },
                values: new object[] { 1, "1", new DateTime(2024, 8, 29, 11, 49, 21, 633, DateTimeKind.Local).AddTicks(5331), 2, 1, "Some message", -1 });
