...
import {
  FocusMonitor
} from "./chunk-QUGFEH7M.js";
import {
  NzFormItemFeedbackIconComponent,
  NzFormNoStatusService,
  NzFormPatchModule,
  NzFormStatusService
} from "./chunk-T6SCFYJX.js";
import {
  MenuService,
...
import {
  ...
  ScrollingModule,
  getPlacementName
} from "./chunk-6Y6OZ7QX.js";
import {
  NzI18nService
} from "./chunk-ZZRIUOAB.js";
import {
  NzButtonComponent,
  NzButtonGroupComponent,
  NzButtonModule
} from "./chunk-PJ4LGWKS.js";
import {
  NzNoAnimationDirective,
  slideMotion
} from "./chunk-5AL5GYL7.js";
import {
  NzIconDirective,
  NzIconModule
} from "./chunk-EH2LMMJS.js";
import "./chunk-STGOCQRS.js";
import {
  CdkPortalOutlet,
  ComponentPortal,
  PortalModule,
  TemplatePortal
} from "./chunk-WX6QBJYD.js";
import {
  NzOutletModule,
  NzStringTemplateOutletDirective
} from "./chunk-FLA6QVUA.js";
import {
  NzTransitionPatchDirective
} from "./chunk-YXPSRSW6.js";
import {
  NzWaveDirective
} from "./chunk-GGYXIF3I.js";
import "./chunk-MT3PJA6R.js";
import "./chunk-PXBE3IJR.js";
import {
  NzResizeObserver
} from "./chunk-AV3HTGBL.js";
import {
  BACKSPACE,
  DOWN_ARROW,
  ENTER,
...
import {
  ...
  measureScrollbar,
  toNumber
} from "./chunk-5MWBAS6P.js";
import {
  Directionality
} from "./chunk-RC7Q54H4.js";
import {
  Platform,
  _getEventTarget
} from "./chunk-MSLX4DFQ.js";
import {
...
var _NzCheckboxComponent = class _NzCheckboxComponent {
  ...
  ngOnInit() {
    this.focusMonitor.monitor(this.elementRef, true).pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe((focusOrigin) => {
      if (!focusOrigin) {
    ...
    this.ngZone.runOutsideAngular(() => {
      ...
      (0, import_rxjs2.fromEvent)(this.inputElement.nativeElement, "click").pipe((0, import_operators2.takeUntil)(this.destroy$)).subscribe((event) => event.stopPropagation());
    });
  }
  ngAfterViewInit() {
    if (this.nzAutoFocus) {
...
var _NzRadioService = class _NzRadioService {
  constructor() {
    this.selected$ = new import_rxjs3.ReplaySubject(1);
    this.touched$ = new import_rxjs3.Subject();
    this.disabled$ = new import_rxjs3.ReplaySubject(1);
    this.name$ = new import_rxjs3.ReplaySubject(1);
  }
  touch() {
    this.touched$.next();
  }
...
var _NzRadioGroupComponent = class _NzRadioGroupComponent {
  ...
  ngOnInit() {
    this.nzRadioService.selected$.pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe((value) => {
      if (this.value !== value) {
        this.value = value;
        this.onChange(this.value);
      }
    });
    this.nzRadioService.touched$.pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe(() => {
      Promise.resolve().then(() => this.onTouched());
    });
    this.directionality.change?.pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe((direction) => {
      this.dir = direction;
      this.cdr.detectChanges();
    });
    this.dir = this.directionality.value;
...
var _NzRadioComponent = class _NzRadioComponent {
  ...
  ngOnInit() {
    if (this.nzRadioService) {
      this.nzRadioService.name$.pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe((name) => {
        this.name = name;
        this.cdr.markForCheck();
      });
      this.nzRadioService.disabled$.pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe((disabled) => {
        this.nzDisabled = this.isNzDisableFirstChange && this.nzDisabled || disabled;
        this.isNzDisableFirstChange = false;
        this.cdr.markForCheck();
      });
    ...
    this.focusMonitor.monitor(this.elementRef, true).pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe((focusOrigin) => {
      if (!focusOrigin) {
        Promise.resolve().then(() => this.onTouched());
        if (this.nzRadioService) {
  ...
  setupClickListener() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs3.fromEvent)(this.elementRef.nativeElement, "click").pipe((0, import_operators3.takeUntil)(this.destroy$)).subscribe((event) => {
...
var _NzEmptyComponent = class _NzEmptyComponent {
  ...
  ngOnInit() {
    this.i18n.localeChange.pipe((0, import_operators4.takeUntil)(this.destroy$)).subscribe(() => {
...
var _NzEmbedEmptyComponent = class _NzEmbedEmptyComponent {
  ...
  subscribeDefaultEmptyContentChange() {
    this.configService.getConfigChangeEventForComponent("empty").pipe((0, import_operators4.startWith)(true), (0, import_operators4.takeUntil)(this.destroy$)).subscribe(() => {
...
function NzSelectTopControlComponent_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵrepeaterCreate(0, NzSelectTopControlComponent_Case_1_For_1_Template, 1, 6, "nz-select-item", 4, _forTrack02);
...
var _NzOptionItemComponent = class _NzOptionItemComponent {
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs5.fromEvent)(this.elementRef.nativeElement, "click").pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
        if (!this.disabled) {
          this.ngZone.run(() => this.itemClick.emit(this.value));
        }
      });
      (0, import_rxjs5.fromEvent)(this.elementRef.nativeElement, "mouseenter").pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
        if (!this.disabled) {
...
var _NzOptionComponent = class _NzOptionComponent {
  ...
  ngOnInit() {
    if (this.nzOptionGroupComponent) {
      this.nzOptionGroupComponent.changes.pipe((0, import_operators5.startWith)(true), (0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
...
var _NzSelectTopControlComponent = class _NzSelectTopControlComponent {
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs5.fromEvent)(this.elementRef.nativeElement, "click").pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((event) => {
        if (event.target !== this.nzSelectSearchComponent.inputElement.nativeElement) {
          this.nzSelectSearchComponent.focus();
        }
      });
      (0, import_rxjs5.fromEvent)(this.elementRef.nativeElement, "keydown").pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((event) => {
...
var NZ_CONFIG_MODULE_NAME2 = "select";
var _NzSelectComponent = class _NzSelectComponent {
  ...
  constructor(ngZone, destroy$, nzConfigService, cdr, host, renderer, platform, focusMonitor, directionality) {
    ...
    this.listOfValue$ = new import_rxjs5.BehaviorSubject([]);
    this.listOfTemplateItem$ = new import_rxjs5.BehaviorSubject([]);
  ...
  ngOnInit() {
    this.nzFormStatusService?.formStatusChanges.pipe((0, import_operators5.distinctUntilChanged)((pre, cur) => {
      return pre.status === cur.status && pre.hasFeedback === cur.hasFeedback;
    }), (0, import_operators5.withLatestFrom)(this.nzFormNoStatusService ? this.nzFormNoStatusService.noFormStatus : (0, import_rxjs5.of)(false)), (0, import_operators5.map)(([{
      status,
      hasFeedback
    }, noStatus]) => ({
      status: noStatus ? "" : status,
      hasFeedback
    })), (0, import_operators5.takeUntil)(this.destroy$)).subscribe(({
      status,
      hasFeedback
    }) => {
      this.setStatusStyles(status, hasFeedback);
    });
    this.focusMonitor.monitor(this.host, true).pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((focusOrigin) => {
      if (!focusOrigin) {
        this.focused = false;
        this.cdr.markForCheck();
        this.nzBlur.emit();
    ...
    (0, import_rxjs5.combineLatest)([this.listOfValue$, this.listOfTemplateItem$]).pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(([listOfSelectedValue, listOfTemplateItem]) => {
    ...
    this.directionality.change?.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((direction) => {
      this.dir = direction;
      this.cdr.detectChanges();
    });
    this.nzConfigService.getConfigChangeEventForComponent("select").pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
      this.cdr.markForCheck();
    });
    this.dir = this.directionality.value;
    this.ngZone.runOutsideAngular(() => (0, import_rxjs5.fromEvent)(this.host.nativeElement, "click").pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
      if (this.nzOpen && this.nzShowSearch || this.nzDisabled) {
        return;
      }
      this.ngZone.run(() => this.setOpenState(!this.nzOpen));
    }));
    this.cdkConnectedOverlay.overlayKeydown.pipe((0, import_operators5.takeUntil)(this.destroy$)).subscribe((event) => {
  ...
  ngAfterContentInit() {
    if (!this.isReactiveDriven) {
      (0, import_rxjs5.merge)(this.listOfNzOptionGroupComponent.changes, this.listOfNzOptionComponent.changes).pipe((0, import_operators5.startWith)(true), (0, import_operators5.switchMap)(() => (0, import_rxjs5.merge)(...[this.listOfNzOptionComponent.changes, this.listOfNzOptionGroupComponent.changes, ...this.listOfNzOptionComponent.map((option) => option.changes), ...this.listOfNzOptionGroupComponent.map((option) => option.changes)]).pipe((0, import_operators5.startWith)(true))), (0, import_operators5.takeUntil)(this.destroy$)).subscribe(() => {
...
var _NzPaginationDefaultComponent = class _NzPaginationDefaultComponent {
  constructor(cdr, renderer, elementRef, directionality) {
    ...
    this.listOfPageItem = [];
    this.dir = "ltr";
    this.destroy$ = new import_rxjs6.Subject();
    renderer.removeChild(renderer.parentNode(elementRef.nativeElement), elementRef.nativeElement);
  }
  ngOnInit() {
    this.directionality.change?.pipe((0, import_operators6.takeUntil)(this.destroy$)).subscribe((direction) => {
      this.dir = direction;
      this.updateRtlStyle();
      this.cdr.detectChanges();
    });
...
var _NzPaginationComponent = class _NzPaginationComponent {
  ...
  constructor(i18n, cdr, breakpointService, nzConfigService, directionality) {
    ...
    this.dir = "ltr";
    this.destroy$ = new import_rxjs6.Subject();
    this.total$ = new import_rxjs6.ReplaySubject(1);
  }
  ngOnInit() {
    this.i18n.localeChange.pipe((0, import_operators6.takeUntil)(this.destroy$)).subscribe(() => {
      this.locale = this.i18n.getLocaleData("Pagination");
      this.cdr.markForCheck();
    });
    this.total$.pipe((0, import_operators6.takeUntil)(this.destroy$)).subscribe((total) => {
      this.onTotalChange(total);
    });
    this.breakpointService.subscribe(gridResponsiveMap).pipe((0, import_operators6.takeUntil)(this.destroy$)).subscribe((bp) => {
...
var _NzSpinComponent = class _NzSpinComponent {
  constructor(nzConfigService, cdr, directionality) {
    ...
    this.destroy$ = new import_rxjs7.Subject();
    this.spinning$ = new import_rxjs7.BehaviorSubject(this.nzSpinning);
    this.delay$ = new import_rxjs7.ReplaySubject(1);
    this.isLoading = false;
    this.dir = "ltr";
  }
  ngOnInit() {
    const loading$ = this.delay$.pipe((0, import_operators7.startWith)(this.nzDelay), (0, import_operators7.distinctUntilChanged)(), (0, import_operators7.switchMap)((delay2) => {
      if (delay2 === 0) {
        return this.spinning$;
      }
      return this.spinning$.pipe((0, import_operators7.debounce)((spinning) => (0, import_rxjs7.timer)(spinning ? delay2 : 0)));
    }), (0, import_operators7.takeUntil)(this.destroy$));
    loading$.subscribe((loading) => {
      this.isLoading = loading;
      this.cdr.markForCheck();
    });
    this.nzConfigService.getConfigChangeEventForComponent(NZ_CONFIG_MODULE_NAME4).pipe((0, import_operators7.takeUntil)(this.destroy$)).subscribe(() => this.cdr.markForCheck());
    this.directionality.change?.pipe((0, import_operators7.takeUntil)(this.destroy$)).subscribe((direction) => {
      this.dir = direction;
      this.cdr.detectChanges();
    });
    this.dir = this.directionality.value;
...
var _NzFilterTriggerComponent = class _NzFilterTriggerComponent {
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs8.fromEvent)(this.nzDropdown.nativeElement, "click").pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((event) => {
        event.stopPropagation();
      });
    });
  }
...
var _NzTableFilterComponent = class _NzTableFilterComponent {
  ...
  constructor(cdr, i18n) {
    ...
    this.destroy$ = new import_rxjs8.Subject();
    this.isChecked = false;
    this.isVisible = false;
  ...
  ngOnInit() {
    this.i18n.localeChange.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(() => {
...
var _NzTableStyleService = class _NzTableStyleService {
  constructor() {
    this.theadTemplate$ = new import_rxjs8.ReplaySubject(1);
    this.tfootTemplate$ = new import_rxjs8.ReplaySubject(1);
    this.tfootFixed$ = new import_rxjs8.ReplaySubject(1);
    this.hasFixLeft$ = new import_rxjs8.ReplaySubject(1);
    this.hasFixRight$ = new import_rxjs8.ReplaySubject(1);
    this.hostWidth$ = new import_rxjs8.ReplaySubject(1);
    this.columnCount$ = new import_rxjs8.ReplaySubject(1);
    this.showEmpty$ = new import_rxjs8.ReplaySubject(1);
    this.noResult$ = new import_rxjs8.ReplaySubject(1);
    this.listOfThWidthConfigPx$ = new import_rxjs8.BehaviorSubject([]);
    this.tableWidthConfigPx$ = new import_rxjs8.BehaviorSubject([]);
    this.manualWidthConfigPx$ = (0, import_rxjs8.combineLatest)([this.tableWidthConfigPx$, this.listOfThWidthConfigPx$]).pipe((0, import_operators8.map)(([widthConfig, listOfWidth]) => widthConfig.length ? widthConfig : listOfWidth));
    this.listOfAutoWidthPx$ = new import_rxjs8.ReplaySubject(1);
    this.listOfListOfThWidthPx$ = (0, import_rxjs8.merge)(
      /** init with manual width **/
      this.manualWidthConfigPx$,
      (0, import_rxjs8.combineLatest)([this.listOfAutoWidthPx$, this.manualWidthConfigPx$]).pipe((0, import_operators8.map)(([autoWidth, manualWidth]) => {
    ...
    this.listOfMeasureColumn$ = new import_rxjs8.ReplaySubject(1);
    this.listOfListOfThWidth$ = this.listOfAutoWidthPx$.pipe((0, import_operators8.map)((list) => list.map((width) => parseInt(width, 10))));
    this.enableAutoMeasure$ = new import_rxjs8.ReplaySubject(1);
  }
...
var _NzTableDataService = class _NzTableDataService {
  ...
  constructor() {
    this.destroy$ = new import_rxjs8.Subject();
    this.pageIndex$ = new import_rxjs8.BehaviorSubject(1);
    this.frontPagination$ = new import_rxjs8.BehaviorSubject(true);
    this.pageSize$ = new import_rxjs8.BehaviorSubject(10);
    this.listOfData$ = new import_rxjs8.BehaviorSubject([]);
    this.listOfCustomColumn$ = new import_rxjs8.BehaviorSubject([]);
    this.pageIndexDistinct$ = this.pageIndex$.pipe((0, import_operators8.distinctUntilChanged)());
    this.pageSizeDistinct$ = this.pageSize$.pipe((0, import_operators8.distinctUntilChanged)());
    this.listOfCalcOperator$ = new import_rxjs8.BehaviorSubject([]);
    this.queryParams$ = (0, import_rxjs8.combineLatest)([this.pageIndexDistinct$, this.pageSizeDistinct$, this.listOfCalcOperator$]).pipe((0, import_operators8.debounceTime)(0), (0, import_operators8.skip)(1), (0, import_operators8.map)(([pageIndex, pageSize, listOfCalc]) => ({
      pageIndex,
      pageSize,
    ...
    this.listOfDataAfterCalc$ = (0, import_rxjs8.combineLatest)([this.listOfData$, this.listOfCalcOperator$]).pipe((0, import_operators8.map)(([listOfData, listOfCalcOperator]) => {
    ...
    this.listOfFrontEndCurrentPageData$ = (0, import_rxjs8.combineLatest)([this.pageIndexDistinct$, this.pageSizeDistinct$, this.listOfDataAfterCalc$]).pipe((0, import_operators8.takeUntil)(this.destroy$), (0, import_operators8.filter)((value) => {
      const [pageIndex, pageSize, listOfData] = value;
      const maxPageIndex = Math.ceil(listOfData.length / pageSize) || 1;
      return pageIndex <= maxPageIndex;
    }), (0, import_operators8.map)(([pageIndex, pageSize, listOfData]) => listOfData.slice((pageIndex - 1) * pageSize, pageIndex * pageSize)));
    this.listOfCurrentPageData$ = this.frontPagination$.pipe((0, import_operators8.switchMap)((pagination) => pagination ? this.listOfFrontEndCurrentPageData$ : this.listOfDataAfterCalc$));
    this.total$ = this.frontPagination$.pipe((0, import_operators8.switchMap)((pagination) => pagination ? this.listOfDataAfterCalc$ : this.listOfData$), (0, import_operators8.map)((list) => list.length), (0, import_operators8.distinctUntilChanged)());
  }
  ngOnDestroy() {
    this.destroy$.next(true);
    this.destroy$.complete();
...
var _NzCustomColumnDirective = class _NzCustomColumnDirective {
  ...
  ngOnInit() {
    this.nzTableDataService.listOfCustomColumn$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((item) => {
      if (item.length) {
        item.forEach((v, i) => {
...
var _NzThAddOnComponent = class _NzThAddOnComponent {
  ...
  constructor(host, cdr, ngZone, destroy$) {
    ...
    this.ngZone = ngZone;
    this.destroy$ = destroy$;
    this.manualClickOrder$ = new import_rxjs8.Subject();
    this.calcOperatorChange$ = new import_rxjs8.Subject();
    this.nzFilterValue = null;
    this.sortOrder = null;
    this.sortDirections = ["ascend", "descend", null];
    this.sortOrderChange$ = new import_rxjs8.Subject();
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => (0, import_rxjs8.fromEvent)(this.host.nativeElement, "click").pipe((0, import_operators8.filter)(() => this.nzShowSort), (0, import_operators8.takeUntil)(this.destroy$)).subscribe(() => {
    ...
    this.sortOrderChange$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((order) => {
...
var _NzTableFixedRowComponent = class _NzTableFixedRowComponent {
  constructor(nzTableStyleService, renderer) {
    ...
    this.renderer = renderer;
    this.hostWidth$ = new import_rxjs8.BehaviorSubject(null);
    this.enableAutoMeasure$ = new import_rxjs8.BehaviorSubject(false);
    this.destroy$ = new import_rxjs8.Subject();
  }
  ngOnInit() {
    if (this.nzTableStyleService) {
      ...
      enableAutoMeasure$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.enableAutoMeasure$);
      hostWidth$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.hostWidth$);
    }
  }
  ngAfterViewInit() {
    this.nzTableStyleService.columnCount$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((count) => {
...
var _NzTrMeasureComponent = class _NzTrMeasureComponent {
  ...
  ngAfterViewInit() {
    this.listOfTdElement.changes.pipe((0, import_operators8.startWith)(this.listOfTdElement)).pipe((0, import_operators8.switchMap)((list) => (0, import_rxjs8.combineLatest)(list.toArray().map((item) => this.nzResizeObserver.observe(item).pipe((0, import_operators8.map)(([entry]) => {
      const {
        width
      } = entry.target.getBoundingClientRect();
      return Math.floor(width);
    }))))), (0, import_operators8.debounceTime)(16), (0, import_operators8.takeUntil)(this.destroy$)).subscribe((data) => {
...
var _NzTbodyComponent = class _NzTbodyComponent {
  constructor() {
    ...
    this.showEmpty$ = new import_rxjs8.BehaviorSubject(false);
    this.noResult$ = new import_rxjs8.BehaviorSubject(void 0);
    this.listOfMeasureColumn$ = new import_rxjs8.BehaviorSubject([]);
    this.destroy$ = new import_rxjs8.Subject();
    ...
    if (this.nzTableStyleService) {
      ...
      noResult$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.noResult$);
      listOfMeasureColumn$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.listOfMeasureColumn$);
      showEmpty$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.showEmpty$);
    }
  }
...
var _NzTableInnerScrollComponent = class _NzTableInnerScrollComponent {
  ...
  constructor(renderer, ngZone, platform, resizeService) {
    ...
    this.data$ = new import_rxjs8.Subject();
    this.scroll$ = new import_rxjs8.Subject();
    this.destroy$ = new import_rxjs8.Subject();
  }
  ngOnChanges(changes) {
    const {
  ...
  ngAfterViewInit() {
    if (this.platform.isBrowser) {
      this.ngZone.runOutsideAngular(() => {
        const scrollEvent$ = this.scroll$.pipe((0, import_operators8.startWith)(null), (0, import_operators8.delay)(0), (0, import_operators8.switchMap)(() => (0, import_rxjs8.fromEvent)(this.tableBodyElement.nativeElement, "scroll").pipe((0, import_operators8.startWith)(true))), (0, import_operators8.takeUntil)(this.destroy$));
        const resize$ = this.resizeService.subscribe().pipe((0, import_operators8.takeUntil)(this.destroy$));
        const data$ = this.data$.pipe((0, import_operators8.takeUntil)(this.destroy$));
        const setClassName$ = (0, import_rxjs8.merge)(scrollEvent$, resize$, data$, this.scroll$).pipe((0, import_operators8.startWith)(true), (0, import_operators8.delay)(0), (0, import_operators8.takeUntil)(this.destroy$));
        setClassName$.subscribe(() => this.setScrollPositionClassName());
        scrollEvent$.pipe((0, import_operators8.filter)(() => !!this.scrollY)).subscribe(() => {
...
var _NzTableComponent = class _NzTableComponent {
  ...
  constructor(elementRef, nzResizeObserver, nzConfigService, cdr, nzTableStyleService, nzTableDataService, directionality) {
    ...
    this.showPagination = true;
    this.destroy$ = new import_rxjs8.Subject();
    this.templateMode$ = new import_rxjs8.BehaviorSubject(false);
    this.dir = "ltr";
    this.verticalScrollBarWidth = 0;
    this.nzConfigService.getConfigChangeEventForComponent(NZ_CONFIG_MODULE_NAME5).pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(() => {
      this.cdr.markForCheck();
    });
  }
  ngOnInit() {
    ...
    this.dir = this.directionality.value;
    this.directionality.change?.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((direction) => {
      this.dir = direction;
      this.cdr.detectChanges();
    });
    queryParams$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.nzQueryParams);
    pageIndexDistinct$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((pageIndex) => {
      if (pageIndex !== this.nzPageIndex) {
        this.nzPageIndex = pageIndex;
        this.nzPageIndexChange.next(pageIndex);
      }
    });
    pageSizeDistinct$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((pageSize) => {
      if (pageSize !== this.nzPageSize) {
        this.nzPageSize = pageSize;
        this.nzPageSizeChange.next(pageSize);
      }
    });
    total$.pipe((0, import_operators8.takeUntil)(this.destroy$), (0, import_operators8.filter)(() => this.nzFrontPagination)).subscribe((total) => {
      if (total !== this.nzTotal) {
        this.nzTotal = total;
        this.cdr.markForCheck();
      }
    });
    listOfCurrentPageData$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((data) => {
      this.data = data;
      this.nzCurrentPageDataChange.next(data);
      this.cdr.markForCheck();
    });
    listOfCustomColumn$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((data) => {
      this.nzCustomColumn = data;
      this.nzCustomColumnChange.next(data);
      this.cdr.markForCheck();
    });
    theadTemplate$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((theadTemplate) => {
      this.theadTemplate = theadTemplate;
      this.cdr.markForCheck();
    });
    (0, import_rxjs8.combineLatest)([tfootTemplate$, tfootFixed$]).pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(([tfootTemplate, tfootFixed]) => {
      this.tfootTemplate = tfootTemplate;
      this.tfootFixed = tfootFixed;
      this.cdr.markForCheck();
    });
    hasFixLeft$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((hasFixLeft) => {
      this.hasFixLeft = hasFixLeft;
      this.cdr.markForCheck();
    });
    hasFixRight$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((hasFixRight) => {
      this.hasFixRight = hasFixRight;
      this.cdr.markForCheck();
    });
    (0, import_rxjs8.combineLatest)([total$, this.templateMode$]).pipe((0, import_operators8.map)(([total, templateMode]) => total === 0 && !templateMode), (0, import_operators8.takeUntil)(this.destroy$)).subscribe((empty) => {
      this.nzTableStyleService.setShowEmpty(empty);
    });
    this.verticalScrollBarWidth = measureScrollbar("vertical");
    this.nzTableStyleService.listOfListOfThWidthPx$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((listOfWidth) => {
      this.listOfAutoColWidth = listOfWidth;
      this.cdr.markForCheck();
    });
    this.nzTableStyleService.manualWidthConfigPx$.pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((listOfWidth) => {
  ...
  ngAfterViewInit() {
    this.nzResizeObserver.observe(this.elementRef).pipe((0, import_operators8.map)(([entry]) => {
      const {
        width
      } = entry.target.getBoundingClientRect();
      const scrollBarWidth = this.scrollY ? this.verticalScrollBarWidth : 0;
      return Math.floor(width - scrollBarWidth);
    }), (0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.nzTableStyleService.hostWidth$);
...
var _NzTrDirective = class _NzTrDirective {
  constructor() {
    this.destroy$ = new import_rxjs8.Subject();
    this.listOfFixedColumns$ = new import_rxjs8.ReplaySubject(1);
    this.listOfColumns$ = new import_rxjs8.ReplaySubject(1);
    this.listOfFixedColumnsChanges$ = this.listOfFixedColumns$.pipe((0, import_operators8.switchMap)((list) => (0, import_rxjs8.merge)(...[this.listOfFixedColumns$, ...list.map((c) => c.changes$)]).pipe((0, import_operators8.mergeMap)(() => this.listOfFixedColumns$))), (0, import_operators8.takeUntil)(this.destroy$));
    this.listOfFixedLeftColumnChanges$ = this.listOfFixedColumnsChanges$.pipe((0, import_operators8.map)((list) => list.filter((item) => item.nzLeft !== false)));
    this.listOfFixedRightColumnChanges$ = this.listOfFixedColumnsChanges$.pipe((0, import_operators8.map)((list) => list.filter((item) => item.nzRight !== false)));
    this.listOfColumnsChanges$ = this.listOfColumns$.pipe((0, import_operators8.switchMap)((list) => (0, import_rxjs8.merge)(...[this.listOfColumns$, ...list.map((c) => c.changes$)]).pipe((0, import_operators8.mergeMap)(() => this.listOfColumns$))), (0, import_operators8.takeUntil)(this.destroy$));
    this.nzTableStyleService = inject(NzTableStyleService, {
      optional: true
    });
    this.isInsideTable = !!this.nzTableStyleService;
  ...
  ngAfterContentInit() {
    if (this.nzTableStyleService) {
      this.listOfCellFixedDirective.changes.pipe((0, import_operators8.startWith)(this.listOfCellFixedDirective), (0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.listOfFixedColumns$);
      this.listOfNzThDirective.changes.pipe((0, import_operators8.startWith)(this.listOfNzThDirective), (0, import_operators8.takeUntil)(this.destroy$)).subscribe(this.listOfColumns$);
      ...
      (0, import_rxjs8.combineLatest)([this.nzTableStyleService.listOfListOfThWidth$, this.listOfFixedLeftColumnChanges$]).pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(([listOfAutoWidth, listOfLeftCell]) => {
      ...
      (0, import_rxjs8.combineLatest)([this.nzTableStyleService.listOfListOfThWidth$, this.listOfFixedRightColumnChanges$]).pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe(([listOfAutoWidth, listOfRightCell]) => {
...
var _NzTheadComponent = class _NzTheadComponent {
  ...
  ngAfterContentInit() {
    if (this.nzTableStyleService) {
      const firstTableRow$ = this.listOfNzTrDirective.changes.pipe((0, import_operators8.startWith)(this.listOfNzTrDirective), (0, import_operators8.map)((item) => item && item.first));
      const listOfColumnsChanges$ = firstTableRow$.pipe((0, import_operators8.switchMap)((firstTableRow) => firstTableRow ? firstTableRow.listOfColumnsChanges$ : import_rxjs8.EMPTY), (0, import_operators8.takeUntil)(this.destroy$));
      listOfColumnsChanges$.subscribe((data) => this.nzTableStyleService.setListOfTh(data));
      this.nzTableStyleService.enableAutoMeasure$.pipe((0, import_operators8.switchMap)((enable) => enable ? listOfColumnsChanges$ : (0, import_rxjs8.of)([]))).pipe((0, import_operators8.takeUntil)(this.destroy$)).subscribe((data) => this.nzTableStyleService.setListOfMeasureColumn(data));
      const listOfFixedLeftColumnChanges$ = firstTableRow$.pipe((0, import_operators8.switchMap)((firstTr) => firstTr ? firstTr.listOfFixedLeftColumnChanges$ : import_rxjs8.EMPTY), (0, import_operators8.takeUntil)(this.destroy$));
      const listOfFixedRightColumnChanges$ = firstTableRow$.pipe((0, import_operators8.switchMap)((firstTr) => firstTr ? firstTr.listOfFixedRightColumnChanges$ : import_rxjs8.EMPTY), (0, import_operators8.takeUntil)(this.destroy$));
    ...
    if (this.nzTableDataService) {
      const listOfColumn$ = this.listOfNzThAddOnComponent.changes.pipe((0, import_operators8.startWith)(this.listOfNzThAddOnComponent));
      const manualSort$ = listOfColumn$.pipe((0, import_operators8.switchMap)(() => (0, import_rxjs8.merge)(...this.listOfNzThAddOnComponent.map((th) => th.manualClickOrder$))), (0, import_operators8.takeUntil)(this.destroy$));
      ...
      const listOfCalcOperator$ = listOfColumn$.pipe(
        (0, import_operators8.switchMap)((list) => (0, import_rxjs8.merge)(...[listOfColumn$, ...list.map((c) => c.calcOperatorChange$)]).pipe((0, import_operators8.mergeMap)(() => listOfColumn$))),
        (0, import_operators8.map)((list) => list.filter((item) => !!item.nzSortFn || !!item.nzFilterFn).map((item) => {
          const {
            nzSortFn,
            sortOrder,
            nzFilterFn,
        ...
        (0, import_operators8.delay)(0),
        (0, import_operators8.takeUntil)(this.destroy$)
      );
