...
import "./chunk-QDSS5K6I.js";
import "./chunk-ELL2T6HD.js";
import {
  __decorate
...
var _NzFormDirective = class _NzFormDirective {
  getInputObservable(changeType) {
    return this.inputChanges$.pipe((0, import_operators2.filter)((changes) => changeType in changes), (0, import_operators2.map)((value) => value[changeType]));
  }
  constructor(nzConfigService, directionality) {
    ...
    this.dir = "ltr";
    this.destroy$ = new import_rxjs2.Subject();
    this.inputChanges$ = new import_rxjs2.Subject();
    this.dir = this.directionality.value;
...
var _NzFormControlComponent = class _NzFormControlComponent {
  ...
  watchControl() {
    ...
    if (this.validateControl && this.validateControl.statusChanges) {
      this.validateChanges = this.validateControl.statusChanges.pipe((0, import_operators2.startWith)(null), (0, import_operators2.takeUntil)(this.destroyed$)).subscribe(() => {
  ...
  subscribeAutoTips(observable) {
    observable?.pipe((0, import_operators2.takeUntil)(this.destroyed$)).subscribe(() => {
      if (!this.disableAutoTips) {
        this.updateAutoErrorTip();
        this.setStatus();
        this.cdr.markForCheck();
  ...
  constructor(cdr, i18n, nzFormStatusService) {
    ...
    this.validateChanges = import_rxjs2.Subscription.EMPTY;
    this.validateString = null;
    ...
    this.subscribeAutoTips(i18n.localeChange.pipe((0, import_operators2.tap)((locale) => this.localeId = locale.locale)));
    this.subscribeAutoTips(this.nzFormDirective?.getInputObservable("nzAutoTips"));
    this.subscribeAutoTips(this.nzFormDirective?.getInputObservable("nzDisableAutoTips").pipe((0, import_operators2.filter)(() => this.nzDisableAutoTips === void 0)));
  }
  ngOnChanges(changes) {
    const {
      nzDisableAutoTips,
...
var _NzFormLabelComponent = class _NzFormLabelComponent {
  ...
  constructor(cdr) {
    ...
    if (this.nzFormDirective) {
      this.nzFormDirective.getInputObservable("nzNoColon").pipe((0, import_operators2.filter)(() => this.noColon === "default"), (0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzTooltipIcon").pipe((0, import_operators2.filter)(() => this._tooltipIcon === "default"), (0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzLabelAlign").pipe((0, import_operators2.filter)(() => this.labelAlign === "default"), (0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => this.cdr.markForCheck());
      this.nzFormDirective.getInputObservable("nzLabelWrap").pipe((0, import_operators2.filter)(() => this.labelWrap === "default"), (0, import_operators2.takeUntil)(this.destroy$)).subscribe(() => this.cdr.markForCheck());
    }
  }
  ngOnDestroy() {
    this.destroy$.next(true);
